...
void Thread::setThreadPriority(int p)
{
    priority = p;
}
...
void Thread::setReadyListTime(int t)
{
	readyListTime = t;
}
int Thread::getReadyListTime()
{
	return readyListTime;
}
...
{
    Thread *nextThread;
    //cout << "yielding " << kernel->currentThread->getName() << endl << endl;
...
Thread::Sleep (bool finishing)
{
    ...
    //cout << kernel->interrupt->getLevel() << endl;
    ASSERT(this == kernel->currentThread);
