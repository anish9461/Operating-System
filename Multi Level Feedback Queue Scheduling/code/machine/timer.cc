...
Timer::CallBack() 
{
    ...
    //cout << "Timer ticks in call back " << kernel->stats->totalTicks << endl;
...
void
Timer::SetInterruptMain(int m) 
{
       // schedule the next timer device interrupt
       kernel->interrupt->Schedule(this, m, MainTimerInt);
