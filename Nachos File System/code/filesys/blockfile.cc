...
int 
IndirectBlock::Allocate(PersistentBitmap *freeMap, int numSectors) { // Initialize a file header, 
...
int 
DoublyIndirectBlock::Allocate(PersistentBitmap *freeMap, int numSectors) { // Initialize a file header, 
