...
OpenFile *file1;
    kernel->fileSystem->Create("file1",12800);

    OpenFile *file2;
    kernel->fileSystem->Create("file2",128000);

    cout << ">===================< Size of File 1 : 12800bytes >================< " << endl << endl;
    cout << ">===================< Size of File 2 : 128Kbytes >===============<" << endl << endl;
    OpenFile *file3;
    kernel->fileSystem->Create("file2",12000);
    interrupt->Enable();
}
